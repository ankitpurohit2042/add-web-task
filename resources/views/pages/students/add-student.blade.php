                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('save-student') }}" id="addStudent" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="grade" class="form-control @error('grade') is-invalid @enderror" name="grade" value="{{ old('grade') }}"  autocomplete="grade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control border-0 @error('image') is-invalid @enderror" name="image"  autocomplete="image">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address"  autocomplete="address"></textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="state" class="form-control @error('state') is-invalid @enderror" name="state"  autocomplete="state">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="city" type="date" class="form-control @error('city') is-invalid @enderror" name="city"  autocomplete="city">
